...
public class DeckOfAffirmationCards {
    ...
    public static final AffirmationCard CARD3 = new AffirmationCard("Divine Wisdom guides me.", "I am guided throughout this day in making the right choices. Divine intelligence continuously guides me in the realization of my goals. I am safe.", Category.GENERAL);
    ...
    public static final AffirmationCard CARD8 = new AffirmationCard("It is safe to look within.", "As I move through the layers of other people's opinions and beliefs, I see within myself a magnificent being, wise and beautiful. I love what I see in me.", Category.SELFLOVE);
    ...
    public static final AffirmationCard CARD10 = new AffirmationCard("Everything I touch is a success.", "I now establish a new awareness of success. I know I can be as successful as I make up my mind to be. I move into the Winning Circle. Golden opportunities are everywhere for me. Prosperity of every Kind is drawn to me.", Category.GENERAL);
